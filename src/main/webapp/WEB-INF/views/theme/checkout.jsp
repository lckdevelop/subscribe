                ...
                <form action="#">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            <h6 class="coupon__code"><span class="icon_tag_alt"></span> 쿠폰이 있으신가요? <a href="#" style="color: blue;">&nbsp;&nbsp;Click
                            here</a></h6>
                            ...
                            <h6 class="checkout__title" style="margin-top: 40px;">배송지 정보</h6>
                            <div class="checkout__input">
                                <p>받는 사람<span>*</span></p>
                                <input type="text">
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <h4 class="order__title" style="margin-top: 40px">할인 및 적립</h4>
                                <button id="check_module" type="submit" class="site-btn">결제하기</button>
                            </div>
                        </div>
                    </div>
                </form>
