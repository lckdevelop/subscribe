...
<head>
    ...
    <link rel="stylesheet" href="${context}/resources/brands/css/mybrands-window.css" type="text/css">
...
<body>
	    ...
	    <div class="row">
	        <div class="col-lg-12">
	            <ul class="filter__controls">
	                <li onclick="location.href='./product'">구독 브랜드 제품</li>
	                <li class="active" onclick="location.href='./window'">브랜드 윈도우</li>
	            </ul>
	        </div>
	    </div>
    </div>
    ...
    <script src="${context}/resources/product/mybrands-window.js"></script>
